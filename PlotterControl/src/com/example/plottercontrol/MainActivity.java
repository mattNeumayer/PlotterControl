...
public class MainActivity extends Activity implements EnterNameDialogListener {
	...
	String[] myStringArray = {"example1.pc", "example2.pc", "example3.pc", "example4.pc", "example5.pc", "example6.pc", "example7.pc", "example8.pc", "example9.pc", "example10.pc", "example11.pc", "example12.pc", "endlichisdielistevoll.boner"};
